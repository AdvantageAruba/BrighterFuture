-- Safe Final Setup Script for Classes, Teachers, and Student Fields
-- This script handles existing objects gracefully and won't fail
...
-- Step 3: Add indexes for better performance (with IF NOT EXISTS)
...
-- Step 5: Insert sample teachers (with ON CONFLICT to handle duplicates)
...
-- Step 7: Add comprehensive student fields (with IF NOT EXISTS)
...
-- Step 8: Create indexes for student fields (with IF NOT EXISTS)
...
-- Step 10: Apply triggers to both tables (with DROP IF EXISTS)
